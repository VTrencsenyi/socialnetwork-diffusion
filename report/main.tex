...
\begin{description}
    ...
    \begin{description}
        \item[Plain]: Vanilla prompt.
        \item[Model of appropriateness]: The agent answers 1. What kind of situation is this? 2. What kind of person am I? 3. What should someone like me do in a situation like this?
        \item[Decision-theoretic]: The LLM must provide a structured JSON schema, populating a decision matrix according to the game definitions, providing a justification for each selected value.   
    \end{description}
\end{description}
...
\begin{figure}[h]
  ...
  \vspace{-0.3em}
  \caption{Adoption rate by design, adopter vs.\ non-adopter sample
  household, $n=20$ reps/arm. Grey: base cases. Red line: the three
  \texttt{A1B1} designs that invert.}
  \label{fig:pilot}
\end{figure}
